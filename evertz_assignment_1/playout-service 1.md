...
- Operators also report that items they *know* exist occasionally don’t show up where expected after a sequence of edits (insert/move/delete), especially during busy shifts.
